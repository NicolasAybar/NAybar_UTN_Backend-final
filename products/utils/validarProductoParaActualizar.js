const PROPIEDADES_NECESARIAS = ['titulo', 'precio', 'stock', 'codigo', 'descripcion','id']
...
const validarPropiedadesProductoActualizar = (producto) => {
    try{
...
module.exports = { validarPropiedadesProductoActualizar }